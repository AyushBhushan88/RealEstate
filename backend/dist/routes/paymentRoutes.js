...
router.post('/create-session', authMiddleware_1.authenticate, paymentController_1.createCheckoutSession);
router.get('/my-transactions', authMiddleware_1.authenticate, paymentController_1.getMyTransactions);
